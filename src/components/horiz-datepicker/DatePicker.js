...
export default function DatePicker({endDate, start_Date, selectDate, getSelectedDay, color, labelFormat}) {
    const [selectedDate, setSelectedDate] = useState(new Date());
    const firstSection = {marginLeft: '40px'};
    const startDate = start_Date == null ? new Date() : start_Date;
    ...
    return (
        <div className={styles.container + " horiz-datepicker"}>
