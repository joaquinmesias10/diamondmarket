...
export const ServicePreview = styled.div`
  width: 50%;
  padding: 20px;
  display: flex;
...
export const ServiceTitlePriceWrapper = styled.div`
  width: 100%;
  display: flex;
  align-items: flex-start;
...
export const ServiceWeight = styled.div`
  font-family: ${themeGet('fonts.body', 'sans-serif')};
  font-size: ${themeGet('fontSizes.sm', '13')}px;
  font-weight: ${themeGet('fontWeights.regular', '400')};
  color: ${themeGet('colors.text.regular', '#77798C')};
...
export const ServiceCartBtn = styled.div`
  .card-counter {
    height: 48px;
    width: 130px;
